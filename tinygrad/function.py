...
class Expand(Function):
  ...
  def backward(self, grad_output:LazyBuffer) -> LazyBuffer: return grad_output.cast(dtypes.float32, False).r(ReduceOps.SUM, self.expanded_axis).cast(grad_output.dtype)
