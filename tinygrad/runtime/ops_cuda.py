...
renderer = functools.partial(uops_to_cstyle, CStyleLanguage(
  ...
  """))
CUDABuffer = Compiled(RawCUDABuffer, LinearizerOptions(supports_float4_alu=False, global_max = [65535, 65535, 65535], local_max=[1024, 1024, 64]), renderer, CUDAProgram, cuda.Context.synchronize)
