...
class Tensor:
  ...
  def realize(self, *lst:Tensor, jit_capture=True, do_update_stats=True) -> Tensor:
    """Triggers the computation needed to create these Tensor(s)."""
    run_schedule(*self.schedule_with_vars(*lst), jit_capture=jit_capture, do_update_stats=do_update_stats)
    return self
